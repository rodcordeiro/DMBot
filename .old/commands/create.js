...
class Character {
  constructor() {
    ...
    this.name =
      functions.randSelect(options.names) +
      ' ' +
      functions.randSelect(options.nicknames);
    this.racialSkills = [];
    this.weakness = [];
  }
}
...
const execute = (bot, msg, args) => {
  ...
  const characterEmbed = new Discord.MessageEmbed()
    ...
    .setThumbnail(
      'https://rodcordeiro.github.io/shares/img/privateinvestocat.jpg',
    )
    .addFields(
      ...
      {
        name: 'Class Expertise',
        value: character.classExpertise,
        inline: true,
      },
      {
        name: 'Special habilities',
        value: character.specialHabilities,
        inline: true,
      },
      { name: '\u200B', value: '\u200B' },
      { name: '\u200B', value: '**Status**' },
    ...
    .setFooter(
      'Created by DMBot',
      'https://rodcordeiro.github.io/shares/img/logo.png',
    );
